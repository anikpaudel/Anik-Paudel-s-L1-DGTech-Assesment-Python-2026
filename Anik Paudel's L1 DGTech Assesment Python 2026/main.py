...
#generating two random numbers      
    ...
    #making sure equation in subtract doesnot have bigger number at front
    if operation == '-':
...
def ask_question():
    ...
    return guess == answer
#generating the final score and game history 
def game():
    score = 0
    history = []
...
#asking user how many questions they want
while True:
